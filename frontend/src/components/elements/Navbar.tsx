    ...
    return <header className="absolute inset-x-0 top-0 z-50 py-6">
        <Container>
            <nav className="flex justify-between gap-6 relative">
                {/* Logo */}
                <div className="min-w-max justify-center relative">
                    <a href="/" className="relative flex item-center gap-3">
                        <img src={logo} alt="Pixel Pursuit" className="w-10 h-15" />
                ...
                lg:items-center absolute top-full left-0 lg:static lg:top-0 border-x border-x-box-border lg:border-x-0 lg:h-auto h-0 overflow-visible">
